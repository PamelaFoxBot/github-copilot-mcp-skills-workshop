...
In this exercise, you will connect to the [GitHub MCP server](https://github.com/github/github-mcp-server), which gives Copilot access to GitHub repositories, issues, pull requests, and more. Unlike the Microsoft Learn server from Exercise 1, this server requires authentication.
